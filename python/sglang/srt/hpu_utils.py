...
if _is_hpu:
    ...
    PREFILL_BUCKET_MAX = get_int_env_var("SGLANG_HPU_PREFILL_BUCKET_MAX", 6144)
    ...
    DECODE_BLOCK_BUCKET_MAX = get_int_env_var(
        "SGLANG_HPU_DECODE_BLOCK_BUCKET_MAX", 4480
    )
    ...
    def create_hpu_block_metadata(
        ...
        if worker_batch.forward_mode.is_decode():
            ...
            # prefix caching is enabled, some blocks might be shared between sequences in the same batch.
            # This is not compatible with contiguous pa
