...
from sglang.srt.utils import cpu_has_amx_support, is_cpu, is_cuda, is_hpu, is_npu
...
if not (_is_cuda or _is_npu or (_is_cpu and _is_cpu_amx_available) or _is_hpu):
